...
function StaffManagement() {
  ...
  const filterOptions = [
    { value: "all", label: "All Staff", count: staffMembers.length },
    {
      value: "active",
      label: "Active",
      count: staffMembers.filter((s) => s.status === "active").length,
    },
    {
      value: "inactive",
      label: "Inactive",
      count: staffMembers.filter((s) => s.status === "inactive").length,
    },
    {
      value: "management",
      label: "Management",
      count: staffMembers.filter((s) => s.department === "Management").length,
    },
    {
      value: "kitchen",
      label: "Kitchen",
      count: staffMembers.filter((s) => s.department === "Kitchen").length,
    },
    {
      value: "service",
      label: "Service",
      count: staffMembers.filter((s) => s.department === "Service").length,
    },
  ];
      ...
      <div className="p-6 space-y-6">
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center">
          <div>
            ...
            <p className="text-base-content/70 font-telugu">సిబ్బంది నిర్వహణ</p>
              ...
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-2xl font-bold text-warning">
                    {formatCurrency(
                      staffMembers.reduce((sum, s) => sum + s.salary, 0) /
                        staffMembers.length
                    )}
                  </p>
                </div>
          ...
          <div className="tabs tabs-boxed">
            {filterOptions.map((option) => (
              <button
                key={option.value}
                className={`tab ${
                  selectedFilter === option.value ? "tab-active" : ""
                }`}
