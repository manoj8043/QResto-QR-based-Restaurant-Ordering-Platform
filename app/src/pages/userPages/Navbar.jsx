...
function Navbar() {
  ...
  const navItems = [
    { name: "Home", path: "#hero" },
    { name: "Menu", path: "#menu" },
    { name: "About", path: "#userPageAbout" },
    { name: "Contact", path: "#userPageSupport" },
          ...
          >
            {navItems.map((item) => (
              <li key={item.name}>
                <Link
                  to={item.path}
                  className="font-elegant text-base-content hover:text-primary"
                >
                  {item.name}
                </Link>
              </li>
        ...
        <Link to="/" className="btn btn-ghost text-xl">
          <div className="flex items-center space-x-2">
            ...
            <div className="flex flex-col">
              ...
              <span className="text-xs text-base-content/70 font-telugu">
                రుచికరమైన ఆహారం
              </span>
            </div>
          </div>
