...
const Hero = () => {
  const features = [
    ...
    { icon: "🌶️", title: "Fresh Spices", desc: "Handpicked spices from local markets" },
    { icon: "👨‍🍳", title: "Expert Chefs", desc: "Master chefs with decades of experience" },
      ...
      <div className="hero-content text-center max-w-7xl mx-auto px-4">
        <div className="max-w-4xl">
          ...
          <p className="text-lg md:text-xl text-base-content/80 mb-8 max-w-3xl mx-auto leading-relaxed">
            At Spice Palace, we don't just serve food — we serve emotions, memories, 
            and joy on every plate. Experience the rich tapestry of Indian cuisine 
            crafted with authentic spices and traditional cooking methods.
          </p>

          {/* CTA Buttons */}
          <div className="flex flex-col sm:flex-row gap-4 justify-center mb-12">
            <Link to="/menu" className="btn btn-primary btn-lg font-elegant text-lg px-8">
              <svg className="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.746 0 3.332.477 4.5 1.253v13C19.832 18.477 18.246 18 16.5 18c-1.746 0-3.332.477-4.5 1.253"></path>
              </svg>
              Explore Menu
            </Link>
            <Link to="/about" className="btn btn-outline btn-lg font-elegant text-lg px-8">
              <svg className="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
            {features.map((feature, index) => (
              <div key={index} className="card bg-base-100/80 backdrop-blur-sm shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
